...
function raycast:IfBlockUnderneath()
	...
	res = workspace:Raycast(Vector3.new(lplr.Character.HumanoidRootPart.Position.X + lplr.Character.Humanoid.MoveDirection.X * (1 * 3), lplr.Character.HumanoidRootPart.Position.Y, lplr.Character.HumanoidRootPart.Position.Z + lplr.Character.Humanoid.MoveDirection.Z * (1 * 3)), Vector3.new(0, -math.huge, 0), rayParams)
